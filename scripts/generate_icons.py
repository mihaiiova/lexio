...
Creates a clean, typographic icon: white "S" in NoticiaText style on black.
...
def draw_icon(size, name):
    ...
    img = Image.new("RGBA", (canvas_size, canvas_size), BLACK + (255,))
...
bg = Image.new("RGBA", (SAFE, SAFE), BLACK + (255,))
