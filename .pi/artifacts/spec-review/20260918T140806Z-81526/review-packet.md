...
Mode: branch review
Base: staging
HEAD: ca4c1f0220b3756c66ad061820f2ea62c64347b4
...
## Diff stat
 ...
 test/games/grammar/grammar_game_test.dart       |  23 ++-
 test/games/idioms/idioms_game_test.dart         |  13 +-
 test/games/spot/spot_game_test.dart             |  15 +-
 ...
 15 files changed, 503 insertions(+), 54 deletions(-)
...
## Verification
- /Users/m/dev/pi-config/scripts/spec/run-checks.sh --check analyze=... --check test=... --check content=... was attempted but the runner failed before checks because macOS /bin/bash 3.2 does not support declare -A.
